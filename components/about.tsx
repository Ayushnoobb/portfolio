                        ...
                        <Card>
                            <CardContent className="p-8">
                                ...
                                <p className="text-muted-foreground leading-relaxed mb-6">
                                    I started my journey in software development
                                    with a Computer Science degree and have
                                    since worked with startups and established
                                    companies, building everything from
                                    responsive web applications to scalable
                                    backend systems.
                                </p>
                                <p className="text-muted-foreground leading-relaxed">
                                    I'm passionate about clean code, user
                                    experience, and staying up-to-date with the
                                    latest technologies. When I'm not coding,
                                    you'll find me contributing to open source
